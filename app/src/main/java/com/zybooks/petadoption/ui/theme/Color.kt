...
// Light Theme Colors
val md_theme_light_primary = Color(0xFF000080)  // Navy color
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFF7DFBA6)  // You might want to adjust this too if necessary
...
val md_theme_light_background = Color(0xFFF1F6F1) // Darker cream background
val md_theme_light_onBackground = Color(0xFF191C19)
val md_theme_light_surface = Color(0xFFF1F6F1) // Darker cream surface
...
val md_theme_light_inversePrimary = Color(0xFF5FDE8C) // Adjust if necessary
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF000080)  // Navy color
val md_theme_light_outlineVariant = Color(0xFFC1C9BF)
val md_theme_light_scrim = Color(0xFF000000)

// Dark Theme Colors
val md_theme_dark_primary = Color(0xFF000080)  // Navy color
val md_theme_dark_onPrimary = Color(0xFF00391B)
val md_theme_dark_primaryContainer = Color(0xFF005229)  // Adjust this container if needed
...
// Updated darker background
val md_theme_dark_background = Color(0xFF2A2F2A)  // Darker cream background for dark theme
val md_theme_dark_onBackground = Color(0xFFE1E3DE)
val md_theme_dark_surface = Color(0xFF2A2F2A)  // Darker cream surface for dark theme
...
val md_theme_dark_inversePrimary = Color(0xFF000080)  // Navy color
val md_theme_dark_shadow = Color(0xFF000000)
val md_theme_dark_surfaceTint = Color(0xFF000080)  // Navy color
val md_theme_dark_outlineVariant = Color(0xFF414941)
val md_theme_dark_scrim = Color(0xFF000000)

val seed = Color(0xFF000080) // Navy color for seed color if needed
